window.AdditionalPostThumbnails = {
    ...
    removeThumbnail: function(id, post_type, nonce){
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    AdditionalPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    },
    ...
    setAsThumbnail: function(thumb_id, id, post_type, nonce){
	    ...
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    win.AdditionalPostThumbnails.setThumbnailID(thumb_id, id, post_type);
			    win.AdditionalPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    }
