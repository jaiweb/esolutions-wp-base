	...
	if ( 'post' == get_post_type() ) {
		if($position=='header'){
			if ( is_singular() || is_multi_author() ) {
				printf( '<span class="byline"><i class="fa fa-user"></i><span class="author vcard"><span class="screen-reader-text">%1$s </span><a class="url fn n" href="%2$s">%3$s</a></span></span>',
		...
		if ( $categories_list && _esc_categorized_blog() ) {
			printf( '<span class="cat-links"><i class="fa fa-folder-open"></i><span class="screen-reader-text">%1$s </span>%2$s</span>',
...
add_action('_before_navigation', '_esc_before_navigation', 10);
